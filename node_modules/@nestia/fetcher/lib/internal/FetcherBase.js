                ...
                return __generator(this, function (_r) {
                    switch (_r.label) {
                        case 0:
                            ...
                            if (!((_o = connection.fetch) !== null && _o !== void 0)) return [3 /*break*/, 1];
                            _a = _o;
                            return [3 /*break*/, 3];
                        ...
                        case 4:
                            ...
                            if (!(result.success === false)) return [3 /*break*/, 6];
                            // WHEN FAILED
                            _b = result;
                        ...
                        case 6:
                            ...
                            return [3 /*break*/, 13];
                        case 7:
                            if (!(((_p = route.response) === null || _p === void 0 ? void 0 : _p.type) === "application/json")) return [3 /*break*/, 9];
                            return [4 /*yield*/, response.text()];
                        case 8:
                            text = _r.sent();
                            ...
                            return [3 /*break*/, 13];
                        case 9:
                            if (!(((_q = route.response) === null || _q === void 0 ? void 0 : _q.type) === "application/x-www-form-urlencoded")) return [3 /*break*/, 11];
                            _c = URLSearchParams.bind;
                            return [4 /*yield*/, response.text()];
                        case 10:
                            query = new (_c.apply(URLSearchParams, [void 0, _r.sent()]))();
                        ...
                        case 11:
                            ...
                            return [4 /*yield*/, response.text()];
                        case 12:
                            _d.data = _f.apply(_e, [_r.sent(), result.headers]);
                            _r.label = 13;
        ...
        switch (_d.label) {
            case 0:
                if (!(typeof global === "object" &&
                    ...
                    typeof global.process.versions.node !== undefined)) return [3 /*break*/, 4];
            ...
            case 3:
                _a;
                return [2 /*return*/, global.fetch];
            case 4: return [2 /*return*/, window.fetch];
        }
    });
}); });
/**
