...
(function (SwaggerSchemaGenerator) {
    SwaggerSchemaGenerator.response = (props) => (route) => {
        ...
        output[status] = Object.assign({ description: route.encrypted
                ? `${warning.get(!!description, "response", route.method)}${description !== null && description !== void 0 ? description : ""}`
                : description !== null && description !== void 0 ? description : "", content: route.output.typeName === "void"
                ? undefined
                : {
    ...
    SwaggerSchemaGenerator.body = (props) => (route) => (param) => {
        ...
        return Object.assign({ description: encrypted
                ? `${warning.get(!!description, "request")}${description !== null && description !== void 0 ? description : ""}`
                : description, content: {
                [contentType]: {
                    schema,
                },
            }, required: true }, (props.config.additional === true
            ? {
    ...
    const headers = (props) => (route) => (param) => decomposible(props)(route)(param)(MetadataFactory_1.MetadataFactory.analyze(props.checker)({
        ...
        constant: true,
        absorb: true,
        validate: param.custom ? SwaggerSchemaValidator_1.SwaggerSchemaValidator.headers : undefined,
    })(props.collection)(param.type));
    const query = (props) => (route) => (param) => decomposible(props)(route)(param)(MetadataFactory_1.MetadataFactory.analyze(props.checker)({
        escape: false,
        constant: true,
        absorb: true,
        validate: param.custom ? SwaggerSchemaValidator_1.SwaggerSchemaValidator.query : undefined,
    })(props.collection)(param.type));
    ...
    const describe = (route, tagName, parameterName) => {
        ...
        const parametric = parameterName
            ? (tag) => tag.text.find((elem) => elem.kind === "parameterName" && elem.text === parameterName) !== undefined
            : () => true;
...
const warning = new tstl_1.VariadicSingleton((described, type, method) => {
