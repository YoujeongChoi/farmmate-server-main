...
(function (SwaggerGenerator) {
    SwaggerGenerator.generate = (checker) => (config) => (routeList) => __awaiter(this, void 0, void 0, function* () {
        ...
        const customizer = {
            ...
            get: new Singleton_1.Singleton(() => (key) => {
                var _a;
                ...
                const path = "/" +
                    key.path
                        ...
                        .join("/");
                return (_a = swagger.paths[path]) === null || _a === void 0 ? void 0 : _a[method];
            }),
        };
        for (const route of routeList) {
            if (false ===
        ...
        yield fs_1.default.promises.writeFile(location, !config.beautify
            ...
            : JSON.stringify(swagger, null, typeof config.beautify === "number" ? config.beautify : 2), "utf8");
    });
    ...
    const generate_route = (props) => (route) => {
        ...
        return Object.assign({ deprecated: deprecated ? true : undefined, tags: [...route.swaggerTags, ...new Set([...getJsDocTexts("tag")])], operationId: (_b = route.operationId) !== null && _b !== void 0 ? _b : (_d = (_c = props.config).operationId) === null || _d === void 0 ? void 0 : _d.call(_c, {
