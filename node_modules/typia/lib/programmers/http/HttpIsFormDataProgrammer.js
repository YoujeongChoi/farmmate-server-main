...
exports.HttpIsFormDataProgrammer = void 0;
var typescript_1 = __importDefault(require("typescript"));
var IdentifierFactory_1 = require("../../factories/IdentifierFactory");
var StatementFactory_1 = require("../../factories/StatementFactory");
var TypeFactory_1 = require("../../factories/TypeFactory");
var IsProgrammer_1 = require("../IsProgrammer");
var HttpFormDataProgrammer_1 = require("./HttpFormDataProgrammer");
var HttpIsFormDataProgrammer;
(function (HttpIsFormDataProgrammer) {
    HttpIsFormDataProgrammer.write = function (project) {
        return function (modulo) {
            return function (type, name) {
                return typescript_1.default.factory.createArrowFunction(undefined, undefined, [
                    ...
                    typescript_1.default.factory.createTypeReferenceNode("typia.Resolved<".concat(name !== null && name !== void 0 ? name : TypeFactory_1.TypeFactory.getFullName(project.checker)(type), ">")),
...
})(HttpIsFormDataProgrammer || (exports.HttpIsFormDataProgrammer = HttpIsFormDataProgrammer = {}));
